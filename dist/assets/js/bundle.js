...
const TodoClient_1 = __webpack_require__(/*! ./TodoClient */ "./src/webpack/TodoClient.ts");
let ApiManager = exports.ApiManager = class ApiManager {
    ...
    fetchData() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const todos = yield this.todoClient.fetchAll();
                console.log(todos);
            }
            catch (error) {
                console.log(error);
...
exports.ApiManager = ApiManager = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(TodoClient_1.TodoClient)),
...
const inversify_1 = __webpack_require__(/*! inversify */ "./node_modules/inversify/es/inversify.js");
let TodoClient = exports.TodoClient = class TodoClient {
...
exports.TodoClient = TodoClient = __decorate([
    (0, inversify_1.injectable)()
], TodoClient);
...
const inversify_config_1 = __importDefault(__webpack_require__(/*! ./inversify.config */ "./src/webpack/inversify.config.ts"));
function fetchData() {
    return __awaiter(this, void 0, void 0, function* () {
        const apiManager = inversify_config_1.default.get("ManagerInterface");
        yield apiManager.fetchData();
    });
}
fetchData();
...
/***/ "./src/webpack/inversify.config.ts":
/*!*****************************************!*\
  !*** ./src/webpack/inversify.config.ts ***!
  \*****************************************/
...
__webpack_require__(/*! reflect-metadata */ "./node_modules/reflect-metadata/Reflect.js");
const inversify_1 = __webpack_require__(/*! inversify */ "./node_modules/inversify/es/inversify.js");
const ApiManager_1 = __webpack_require__(/*! ./ApiManager */ "./src/webpack/ApiManager.ts");
const TodoClient_1 = __webpack_require__(/*! ./TodoClient */ "./src/webpack/TodoClient.ts");
const container = new inversify_1.Container();
container.bind("ManagerInterface").to(ApiManager_1.ApiManager);
container.bind(TodoClient_1.TodoClient).toSelf();
